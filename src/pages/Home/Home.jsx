  ...
  return (
    <div>
      <div className="home">
        ...
        <img src={Logo} alt="Retirement flip flop" />/
        <h1 className="header">Upcomming Activities</h1>
        ...
        <div>
          ...
          <button class="btn">
            <FontAwesomeIcon icon={faPeopleGroup}></FontAwesomeIcon>community
            request
          </button>
          <button class="btn">
            <FontAwesomeIcon icon={faClock}></FontAwesomeIcon> hours avaiable to
            use
          </button>
          <button class="btn">
